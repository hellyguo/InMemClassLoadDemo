 ...
 */
public class InMemClassLoaderJdk11Test {

    private static final Logger LOGGER = LoggerFactory.getLogger(InMemClassLoaderJdk11Test.class);
    ...
    public void testUnsafe() {
        Class<? extends SimTarget> targetClass =
                (Class<? extends SimTarget>) new InMemClassLoaderAnonImpl().loadClass("demo.base.impl.SimTargetImpl",
                                                                                      SimTargetBytes.SIM_TARGET_BYTES);
        callClass(targetClass);
    }
